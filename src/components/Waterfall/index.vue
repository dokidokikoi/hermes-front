...
import BScrollBox from '../BScrollBox/index.vue'
        ...
        list.value.push(...[
            {
                ...
                price: 10,
                src: {
                    original: Math.random() > 0.1 ? "https://cdn.shopify.com/s/files/1/2418/2505/files/JustOneMorePlants-PersonalizedTShirt-BD1574-CLA1193-Default.webp?v=1750904437" : 'https://www.example.com/non-existent-image.jpg',
